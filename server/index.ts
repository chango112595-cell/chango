...
// Mount Dev Write router under /api path
app.use('/api', devWriteRouter);
...
// Register NLP reply route at /nlp (not /api/nlp)
registerReply(app);
...
(async () => {
  ...
  // MCP is now registered at the top of the middleware chain
